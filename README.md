...
This R package provides methods and data to enable reproduction of the results presented in "Estimation of adult butterfly lifespan using long-term citizen-science count data" (Clarke, Dennis, Morgan, Grose and McCrea 2026)
